...
# ===================================================
from NewERFNet import NewERFAnet, constrained_loss2

from NNUtils import sigmoid_rampup, exp_rampup

# =======================================================================================
# self supervision on encoder
# self supervision loss is based on entropy
...
def trainSingleModel(model,
    ...
    for epoch in range(num_epochs):
        ...
        for j, (images1, images2, images3, labels, imagename) in enumerate(trainloader):
            ...
            self_constrained_loss = constrained_loss2(pseudo_x1_a, pseudo_x1_b, pseudo_x3_a, pseudo_x3_b)
