...
def prepare_data(new_size, scans_folder, labels_folder, save_folder, input_dim, train_amount_slices, case_no):
    ...
    if input_dim == 3:
        save_lo = save_folder + '/dense_' + str(case_no) + '_r' + str(new_size) + '_s' + str(train_amount_slices)
    elif input_dim == 1:
        save_lo = save_folder + '/dense_' + str(case_no) + '_r' + str(new_size) + '_s' + str(train_amount_slices)
    elif input_dim == 5:
        save_lo = save_folder + '/dense_' + str(case_no) + '_r' + str(new_size) + '_s' + str(train_amount_slices)
    ...
    pre_process(new_size=new_size, all_cases_scans=train_withlabels_scans, all_cases_labels=train_withlabels_labels, save_folder=train_save_folder, input_dim=input_dim, train_amount_slices=train_amount_slices, with_label=True, sample_mode='dense')
