...
# self supervision on features before the last convolutional layer
...
def trainSingleModel(model,
    ...
    for epoch in range(num_epochs):
        ...
        for j, (images1, images2, images3, labels, imagename) in enumerate(trainloader):
            ...
            pseudo_fp1_a, pseudo_fp1_b, pseudo_fp3_a, pseudo_fp3_b = pseudo_features(outputs_fp1_, outputs_fp2_, outputs_fp3_)
            pseudo_fn1_a, pseudo_fn1_b, pseudo_fn3_a, pseudo_fn3_b = pseudo_features(outputs_fn1_, outputs_fn2_, outputs_fn3_)
