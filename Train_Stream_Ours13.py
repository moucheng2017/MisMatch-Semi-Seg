...
# semi supervision on BOTH encoder and decoder
# consistency loss on unsupervised part of semi supervision
# when annealing down the weight, we do it inside of each iteration!
# Encoder has higher learning rate
# =======================================================================================
...
def trainSingleModel(model,
    ...
    optimizer_encoder = torch.optim.AdamW(encoder, lr=10*learning_rate, betas=(0.9, 0.999), eps=1e-8, weight_decay=1e-5)
