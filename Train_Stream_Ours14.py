...
# Encoder has lower learning rate
# =======================================================================================
...
def trainSingleModel(model,
    ...
    optimizer_encoder = torch.optim.AdamW(encoder, lr=0.4*learning_rate, betas=(0.9, 0.999), eps=1e-8, weight_decay=1e-5)
