...
# ===================================================
from NewERFNet import NewERFAnet, constrained_loss4

from NNUtils import sigmoid_rampup, exp_rampup

# =======================================================================================
# self supervision on encoder
# self supervision loss is based on entropy, kl divergence
...
def trainSingleModel(model,
    ...
    for epoch in range(num_epochs):
        ...
        for j, (images1, images2, images3, labels, imagename) in enumerate(trainloader):
            ...
            self_constrained_loss = constrained_loss4(pseudo_x1_a, pseudo_x1_b, pseudo_x3_a, pseudo_x3_b)
            self_constrained_loss = self_constrained_loss*gamma
