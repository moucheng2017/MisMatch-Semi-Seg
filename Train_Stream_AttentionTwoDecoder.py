...
from New_baseline import AttentionTwoDecoder
...
def trainModels(dataset_tag,
    ...
    for j in range(1, repeat + 1):
        ...
        Exp = AttentionTwoDecoder.AttentionDecoderUnet(in_ch=input_dim, width=width, class_no=class_no)

        Exp_name = 'AttentionTwoDecoder' + \
